...
<template>
  ...
  >
    <div
      class="relative h-[115px] w-full rounded border border-base-100 ring-none ring-offset-2 ring-info-background-on ring-offset-white group-hover/block:border-info group-focus-within/block:ring dark:group-focus/block:ring-offset-[#0f172a] group-focus/block:border-0"
    >
    ...
    <p class="mt-1 h-10 truncate text-center text-[0.8125rem] leading-5 text-base-500 group-focus/block:line-clamp-2 group-focus/block:whitespace-normal group-hover/block:line-clamp-2 group-hover/block:whitespace-normal">
      {{ icon.name }}
    </p>
  </button>
</template>
